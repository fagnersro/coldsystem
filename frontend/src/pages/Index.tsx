                  ...
                  <tbody>
                    {equipments.map((e) => (
                      <tr key={e.id} className="border-b last:border-0">
                        <td className="py-2 pr-4">{e.identification.placa}</td>
                        <td className="py-2 pr-4">{e.identification.modelo}</td>
                        <td className="py-2 pr-4 capitalize">{e.status}</td>
                        <td className="py-2 pr-4">
                          <Button asChild variant="link" size="sm"><Link to={`/equipments/${e.id}`}>Ver detalhes</Link></Button>
                        </td>
                      </tr>
                    ))}
                  </tbody>
